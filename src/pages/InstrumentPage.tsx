  ...
  return (
    <div style={{ width: '100vw', height: '100vh', background: '#050810', position: 'relative', overflow: 'hidden' }}>
      <div style={{ width: '100%', height: '100%', opacity: isPlaying ? 1 : 0, transition: 'opacity 1s ease-in' }}>
        <Canvas dpr={[1, 2]} camera={{ position: [0, 0, 1.4], fov: 60 }} style={{ touchAction: 'none' }}>
          <color attach="background" args={['#050810']} />
          <ambientLight intensity={0.2} />
          <pointLight position={[10, 10, 10]} intensity={0.5} />
          <InstrumentScene activeRows={activeRows} handleInteraction={handleInteraction} showRibbon={showRibbon} />
        </Canvas>
      </div>
